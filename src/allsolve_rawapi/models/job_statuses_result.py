...
class JobStatusesResult(BaseModel):
    """
    JobStatusesResult
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobStatusesResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobStatusesResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "statuses": [JobStatus.from_dict(_item) for _item in obj["statuses"]] if obj.get("statuses") is not None else None
        })
        return _obj
