...
class ExpressionBoundingBox(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpressionBoundingBox from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpressionBoundingBox from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "min": ExpressionVector.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": ExpressionVector.from_dict(obj["max"]) if obj.get("max") is not None else None
        })
        return _obj
