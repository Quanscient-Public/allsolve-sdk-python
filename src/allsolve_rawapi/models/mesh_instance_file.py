...
class MeshInstanceFile(BaseModel):
    """
    MeshInstanceFile
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "index", "overrides"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeshInstanceFile from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeshInstanceFile from a dict"""
        if obj is None:
            return None
