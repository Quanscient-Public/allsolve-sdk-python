...
class JobStatus(BaseModel):
    ...
    progress: Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]
    __properties: ClassVar[List[str]] = ["jobId", "status", "statusReason", "progress"]
